...
This project is designed with clean data structures, file handling, linked lists, and circular transaction logs—ideal for learning and interview showcases.
...
> **Complete flowchart of program execution**
> *(Add the Flowchart.png inside the Images folder in your repo)*
